...
INSERT INTO `review` (`id`, `book_id`, `review_text`, `rating`, `review_date`) VALUES (5, 5, 'Ever wanted to read a collection of stories that feel like fever dreams you barely remember, but somehow leave you questioning reality? Murakami delivers his usual recipe: throw in some disappearing elephants, existential dread, and a guy making spaghetti alone at night. If you like your short stories to end with more confusion than closure, this one’s a masterpiece.', NULL, NULL);
INSERT INTO `review` (`id`, `book_id`, `review_text`, `rating`, `review_date`) VALUES (6, 6, 'Nothing screams ‘uplifting read’ like watching two sisters make progressively worse life choices for 200+ pages. Yates masterfully reminds us that happiness is a fleeting illusion, and no matter what path you take, disappointment is inevitable. Perfect for when you want your soul gently crushed beneath the weight of unfulfilled dreams.', NULL, NULL);
INSERT INTO `review` (`id`, `book_id`, `review_text`, `rating`, `review_date`) VALUES (7, 7, 'Ever wondered what it’s like to be a painfully awkward young soldier fumbling his way through war and an overbearing mother’s failed artistic dreams? Yates delivers his signature dose of bleak reality, proving that coming-of-age stories can be just as depressing as his tales of broken marriages. If you love secondhand embarrassment and existential despair, this one’s a must-read.', NULL, NULL);
INSERT INTO `review` (`id`, `book_id`, `review_text`, `rating`, `review_date`) VALUES (8, 8, 'Finally, a book that makes you feel both like a genius and a complete idiot at the same time. It starts off holding your hand like a kind kindergarten teacher, but before you know it, you’re drowning in syntax errors wondering if computers were a mistake. Perfect for anyone who enjoys spending hours debugging a missing semicolon.', NULL, NULL);
INSERT INTO `review` (`id`, `book_id`, `review_text`, `rating`, `review_date`) VALUES (9, 9, 'For those who thought \'Hey, I’m already a complete idiot—might as well program!\' This book promises to turn you into a coding genius... or at least help you stumble through the basics without accidentally deleting your entire system. Ideal for anyone who’s ever looked at code and wondered, ‘Is this written in another language, or am I just dumb?', NULL, NULL);
INSERT INTO `review` (`id`, `book_id`, `review_text`, `rating`, `review_date`) VALUES (10, 10, 'Ready to become as cold, calculating, and utterly emotionless as your favorite computer? This book will guide you through the thrilling process of mimicking a machine’s logic—because who needs human creativity or intuition when you can think in binary? Perfect for anyone who’s ever wished they could process data without ever having to experience joy or uncertainty.', NULL, NULL);
INSERT INTO `review` (`id`, `book_id`, `review_text`, `rating`, `review_date`) VALUES (11, 11, 'Because what better way to land your dream coding job than by following a step-by-step guide that treats you like you’ve never touched a computer before? This book will help you craft the perfect resume, ace an interview, and still somehow end up asking, \'So, what exactly is a compiler?\' Perfect for when you’re ready to dive into tech... but not quite ready to actually know what tech is.', NULL, NULL);
